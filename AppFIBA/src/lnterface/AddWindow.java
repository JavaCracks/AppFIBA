...
//	        teamTxt.setBackground(new Color(85,85,85,85));
		teamTxt.setForeground(Color.BLACK);
...
//	        heightTxt.setBackground(new Color(85,85,85,85));
	...
	public void components() {
		...
		AuxOne.add(drbTxt);
		AuxOne.add(defense);
		AuxOne.add(defenseTxt);
		AuxOne.add(offense);
		AuxOne.add(offenseTxt);
		AuxOne.add(salary);
		AuxOne.add(salaryTxt);
		AuxOne.add(weight);
		AuxOne.add(weightTxt);
		AuxOne.add(height);
		AuxOne.add(heightTxt);
